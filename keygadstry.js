 ...
 *
 * NOTE: Jakir Hossain  is not original developer of this script.
 * This script can be used adding proper credits.We will be happy to give proper credits.
 */
...
(function ($) {
    ...
    $.fn.QueryKeyword = function (keyword) {
        ...
        $.ajax({
            url: "https://www.google.com/s?gs_rn=18&gs_ri=psy-ab&cp=7&gs_id=d7&xhr=t&q=",
            jsonp: "jsonp",
            dataType: "jsonp",
            data: {
                q: querykeyword,
